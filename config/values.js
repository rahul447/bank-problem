const values = {
    ...
    featureTypes: ['COURSE', 'TEST', 'FORMULA', 'PACKAGE', 'TAG', 'LANGUAGE', 'GRADE', 'TESTTYPE', 'AUDIO', 'VIDEO', 'STUDYMATERIAL', 'QUESTION', 'CONTENT', 'CLIENT', 'CONTENTSETTING', 'COURSESYLLABUS', "USER", "RULE"],
