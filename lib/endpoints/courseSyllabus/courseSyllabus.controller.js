...
let courseSyllabusControllerInstance,
...
export function getcourseSyllabusControllerInstance() {
    courseSyllabusControllerInstance = courseSyllabusControllerInstance || new courseSyllabusController(loggerInstance, config);
    return courseSyllabusControllerInstance;
}