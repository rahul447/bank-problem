...
export class ContentController {
    ...
    publishContent(req, res) {
        ...
        switch (contentType) {
            case 'question':
                this.questionInstance.publishQuestion(contentId)
                .then((data) => {
            ...
            case 'testpapers':
                ...
                .catch((err) => {
                    ...
                    return res.json(new ResponseController(500, "publish Test Error ", err));
                });
                break;
            case 'formulas':
                ...
                .catch((err) => {
                    ...
                    return res.json(new ResponseController(500, "publish Formula Error ", err));
                });
                break;
            case 'videos':
                ...
                .catch((err) => {
                    ...
                    return res.json(new ResponseController(500, "publish Video Error ", err));
                });
                break;
            case 'audios':
                ...
                .catch((err) => {
                    ...
                    return res.json(new ResponseController(500, "publish Audio Error ", err));
                });
                break;
            default:            // for audios
        }
