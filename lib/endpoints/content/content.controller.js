        ...
        return new Promise((resolve, reject) => {
            ...
            if (contentType === 'testpapers') {
                ...
                if(searchedInput) {
                    ...
                    query.$and.push({ $or: [ { "contentId": searchedInput.trim()},
                            { "name": {'$regex': searchedInput.trim(), $options: 'i'} } ] });
                }
                ...
                if(searchedInput) {
                    query.$and.push({ "status": {"$ne": "DELETED"} });
                    query.$and.push({ $or: [ { "contentId": searchedInput.trim()},
                            { "content.questionContent": { "$regex": searchedInput.trim(), $options: 'i' }}
                        ] });
                }
                ...
                if(searchedInput) {
                    query.$and.push({ "status": {"$ne": "DELETED"} });
                    query.$and.push({ $or: [ { "contentId": searchedInput.trim()},
                            { "content.title": { "$regex": searchedInput.trim(), $options: 'i' }}
                        ] });
                }
        ...
        return new Promise((resolve, reject) => {
            ...
            if (contentType === 'testpapers') {
                ...
                if(searchedInput) {
                    query.$and.push({ "status": {"$ne": "DELETED"} });
                    query.$and.push({ $or: [
                            { "contentId": {'$regex': searchedInput.trim(), $options: 'i'}},
                            //{ "contentId": searchedInput.trim()},
                            { "name": {'$regex': searchedInput.trim(), $options: 'i'} } ] });
                }
