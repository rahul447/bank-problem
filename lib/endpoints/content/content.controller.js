        ...
        switch (contentType) {
            case 'question':
                try {
                    ...
                    const code = validate ? 200 : 500;
                    this.loggerInstance.info(`validateQuestion Done`);
                    return res.json(new ResponseController(code, "validateQuestion Done ", {validate}));
                } catch(err) {
            ...
            case 'studymaterial':
                try {
                    ...
                    const code = validate ? 200 : 500;
                    this.loggerInstance.info(`publish Study Material Done`);
                    return res.json(new ResponseController(code, "validate Study Material Done ", {validate}));
                } catch(err) {
            ...
            case 'testpapers':
                try {
                    ...
                    return res.json(new ResponseController(code, "validate Test Done ", {validate}));
                } catch(err) {
            ...
            case 'formulas':
                try {
                    ...
                    return res.json(new ResponseController(code, "validate Formula Done ", {validate}));
                } catch(err) {
            ...
            case 'videos':
                try {
                    ...
                    return res.json(new ResponseController(code, "validate Video Done ", {validate}));
                } catch(err) {
                    this.loggerInstance.error(`validate Formula Error ${err}`);
                    return res.json(new ResponseController(500, "validate Formula Error ", err.message));
                }
