...
export class ContentController {
    ...
    deleteObject(req, res) {
        ...
        let update = {'$set':{'status':'DELETED', 'lastUpdateBy': req.body.lastUpdateBy}};
    ...
    async publishContent(req, res) {
        ...
        let {lastUpdateBy} = req.body;
        switch (contentType) {
            case 'question':
                try {
                    await this.questionInstance.publishQuestion(contentId, lastUpdateBy);
                ...
                break;
            case 'studymaterial':
                this.studyMaterialInstance.publishMaterial(contentId, lastUpdateBy)
                .then((data) => {
                ...
                break;
            case 'testpapers':
                this.testInstance.publishTest(contentId, lastUpdateBy)
                .then((data) => {
                ...
                break;
            case 'formulas':
                this.formulaInstance.publishFormula(contentId, lastUpdateBy)
                .then((data) => {
                ...
                break;
            case 'videos':
                this.videoInstance.publishVideo(contentId, lastUpdateBy)
                .then((data) => {
                ...
                break;
            case 'audios':
                this.audioInstance.publishAudio(contentId, lastUpdateBy)
                .then((data) => {
