...
export function getGradeControllerInstance() {
    GradeControllerInstance = GradeControllerInstance || new GradeController(loggerInstance, config);
    return GradeControllerInstance;
}