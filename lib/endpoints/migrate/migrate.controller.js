...
export class MigrateController {
    ...
    pushSubjectsToElastic(subjects) {
        ...
        subjects.map(subject => {
            bulkData.push({ index: { _index: 'cms-subjects', _type: 'cms-subjects' } }, {
    ...
    pushSubChapToElastic(subjectAndChapter) {
        ...
        subjectAndChapter.map(doc => {
            bulkData.push({ index: { _index: 'cms-subjects-chapters', _type: 'cms-subjects-chapters' } }, {
    ...
    pushSubChapConToElastic(subjectChapterAndConcept) {
        ...
        subjectChapterAndConcept.map(doc => {
            bulkData.push({ index: { _index: 'cms-subjects-chapters-concepts', _type: 'cms-subjects-chapters-concepts' } }, {
