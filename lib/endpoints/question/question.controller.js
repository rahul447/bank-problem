...
export class QuestionController {
    ...
    questionSave(req, res) {
        ...
        ((that) => {
            ...
            .catch(function(err) {
                ...
                res.json(new ResponseController(500, "Error saving question"));
            })
        })(this)
    }
    ...
    questionEdit(req, res){
        let question = new this.questionModelInstance(req.body);
        ((that)=>{
            this.questionModelInstance.findOneAndUpdate({_id:question._id},question,{new: true})
            ...
            .catch(function(err){
                that.loggerInstance.error("DB Error saving question");
                res.json(new ResponseController(500, "Error updating question"));
            })
        })(this)
    }
}