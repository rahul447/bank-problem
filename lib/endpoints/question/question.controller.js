...
class QuestionController {
    ...
    publishQuestion(questionId, aclMetaData) {
        return new Promise((resolve, reject) => {
            ((that) => {
                ...
                exec(function (err, doc) {
                    if(err) {
                        ...
                        if(doc.draftId) {
                            ...
                            that.deleteQuestion(doc.draftId)
                            .then(() => {
    ...
    validateOnly(doc) {
        let status = {'tolerance': true, 'conceptId': true, 'questionContent': true, 'solutionContent': true, 'correctAnswer': true, 'optionsContent': true, 'matrixOptionContent': true, 'concepts': true};
