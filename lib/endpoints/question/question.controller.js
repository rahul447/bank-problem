...
export class QuestionController {
    ...
    questionSave(req, res) {
        ...
        if(req.body.hasOwnProperty("_id") && question.hasOwnProperty("content")){
            ((that)=>{
                that.questionModelInstance.findOneAndUpdate({_id:question._id},{'$push':{'content':question.content}},{new: true})
        ...
        else if(question.hasOwnProperty("content")){
            ((that) => {
                question.save()
