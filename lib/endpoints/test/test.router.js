...
updateTestRoute.post(testInstance.updateTest.bind(testInstance));
...
router.route('/addToCourseViaExcel').post(testInstance.addToCourseViaExcel.bind(testInstance));
