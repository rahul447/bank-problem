...
TestsSchema.methods.checkValidity = function() {
    ...
    let status = {'name': true, 'displayName': true, 'testCode': true, 'testType': true, 'duration': true, 'language': true, 'Rules': true, 'DuplicateSection': true, 'QuestionNotEqual': true, 'DuplicateQuestion': true};
                ...
                sec.subSection.map(async subSec => {
                    ...
                    subSec.questions.map(ques => {
                        ...
                        promises.push(new Promise((resolve) =>
                            questionInstance.publishQuestion(ques.qId)
                                .then((msg) => {
                                    resolve();
                                }).catch(err => {
