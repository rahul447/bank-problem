    ...
    function validate(key) {
        ...
        if(key === 'settings') {
            if (test[key].testType.length === 0) {
                status.push("testType");
            }

            if (test[key].duration.length === 0) {
                status.push("duration");
            }

            if (test[key].language.length === 0) {
                status.push("language");
            }
        }
