...
export class PackageController {
    ...
    addCourseItemToPackage(req, res) {
        console.log("req.body.selectedCourseItems : ", req.body.selectedCourseItems);
                       ...
                       selected.map(inner => {
                           if(inner.testId) {
                               !includeObj.partialDataDetails.testIDs ? includeObj.partialDataDetails
                                   .testIDs = []: '';
                               includeObj.itemId = req.body.courseItemMap.testId;
                           ...
                           if(inner.scheduleID) {
                               !includeObj.partialDataDetails.scheduleIDs ? includeObj.partialDataDetails
                                   .scheduleIDs = []: '';
                               includeObj.itemId = req.body.courseItemMap.scheduleID;
                           ...
                           if(inner.sampleTestId) {
                               !includeObj.partialDataDetails.sampleTestId ? includeObj.partialDataDetails
                                   .sampleTestId = []: '';
                               includeObj.itemId = req.body.courseItemMap.sampleTestId;
