...
class ConceptController {
    ...
    getConceptDocById(idArr) {
        return this.conceptModelInstance.find({_id: { "$in": idArr}}).exec()
    }

}

export function getConceptControllerInstance() {
    ConceptControllerInstance = ConceptControllerInstance || new ConceptController(loggerInstance, config);
    return ConceptControllerInstance;
}