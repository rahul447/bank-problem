...
export class courseItemController {
    ...
    async createTest (req, res) {
        try {
            let {
                courseItemId, scheduleDate, scheduleEndDate, displayName, testType, status, codeName, duration, testId
            } = req.body;
            let paperDetail;
            if (testId) {
            ...
            const testsMap = {
                scheduledTests: 'schedule',
                sampleTests: 'sampletests',
                testGroup: 'tests'
            }
            courseItemDetails.details[testsMap[courseItemDetails[itemType]]].push(newTest);
