...
export function getChapterControllerInstance() {
    ChapterControllerInstance = ChapterControllerInstance || new ChapterController(loggerInstance, config);
    return ChapterControllerInstance;
}