...
export function getLanguageControllerInstance() {
    LanguageControllerInstance = LanguageControllerInstance || new LanguageController(loggerInstance, config);
    return LanguageControllerInstance;
}