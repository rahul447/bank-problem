...
let SubCategoryControllerInstance,
    ...
    get(req, res) {
        if (req.params.id) {
            ...
            if (req.query.category) {
                query['categoryId.id'] = req.query.category;
            }
...
export function getSubCategoryControllerInstance() {
    SubCategoryControllerInstance = SubCategoryControllerInstance || new SubCategoryController({loggerInstance, config});
    return SubCategoryControllerInstance;
}