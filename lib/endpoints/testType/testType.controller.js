...
let TestTypeControllerInstance,
...
export function getTestTypeControllerInstance() {
    TestTypeControllerInstance = TestTypeControllerInstance || new TestTypeController({loggerInstance, config});
    return TestTypeControllerInstance;
}