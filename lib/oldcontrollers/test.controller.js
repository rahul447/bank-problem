                    ...
                    if(!courseItemArray)
                        ...
                        async.eachLimit(courseItemArray.courseItems,5,function (courseItem, courseItemCallback) {
                                ...
                                if (courseItem.itemType === 'scheduledTests') {
                                    CourseItems.findOne({ '_id': courseItem.id,'details.schedule.paperDetail.id':testId }, function (err, courseItemResult) {
                                        if (err) {
                                            console.log(err);
                                    ...
                                    CourseItems.findOne({ '_id': courseItem.id,'details.sampletests.paperDetail.id':testId }, function (err, courseItemResult) {
                                        if (err) {
                                            console.log(err);
                                            courseItemCallback(err);
                                        }
                                    ...
                                    CourseItems.findOne({ '_id': courseItem.id,'details.tests.paperDetail.id':testId }, function (err, courseItemResult) {
                                        if (err) {
                                            console.log(err);
                                            courseItemCallback(err);
                                        }
